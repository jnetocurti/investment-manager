...
public class PositionImpactEvent {
    ...
    public void validate() {
        if (originalEventId == null || originalEventId.isBlank()) throw new IllegalArgumentException("Original event ID is required");
        if (ticker == null || ticker.isBlank()) throw new IllegalArgumentException("Ticker is required");
        if (impactType == null) throw new IllegalArgumentException("Impact type is required");
        ...
        if (originType == null) throw new IllegalArgumentException("Origin type is required");
        if (sourceType == null) throw new IllegalArgumentException("Source type is required");
        if (brokerId == null || brokerId.isBlank()) throw new IllegalArgumentException("Broker ID is required");
        if (factor != null && factor.compareTo(BigDecimal.ZERO) <= 0) throw new IllegalArgumentException("Factor must be > 0 when provided");
        if (schemaVersion <= 0) throw new IllegalArgumentException("Schema version must be > 0");
    }
}
