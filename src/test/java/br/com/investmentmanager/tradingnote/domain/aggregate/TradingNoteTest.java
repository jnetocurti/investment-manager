...
class TradingNoteTest {
    ...
    public static void setup() {
        tradingNote = TradingNote.valueOf(loadFile("trading-notes/Invoice_103226.pdf"));
    }
    ...
    void valueOfShouldCreateItemsData() {
        ...
        assertEquals(TradingNoteItem.of("CPTS11", new BigDecimal("94.60"), new BigDecimal("2"), "C",
                new BigDecimal("189.20"), new BigDecimal("189.254490"), "BRL"), items.get(0));
        assertEquals(TradingNoteItem.of("KNRI11", new BigDecimal("132.19"), new BigDecimal("3"), "C",
                new BigDecimal("396.57"), new BigDecimal("396.684212"), "BRL"), items.get(1));
        assertEquals(TradingNoteItem.of("MXRF11", new BigDecimal("9.74"), new BigDecimal("4"), "C",
                new BigDecimal("38.96"), new BigDecimal("38.971220"), "BRL"), items.get(2));
